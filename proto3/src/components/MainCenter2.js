      ...
      <div className={styles.frameParent}>
        <div className={styles.componentcardplacecardGenWrapper}>
          <div className={styles.componentcardplacecardGen}>
            <img
              ...
              loading="lazy"
              alt=""
              src="/componentcardglobalmedia-landscape@2x.png"
            />
        ...
        <div className={styles.componentcardplacecardGen1}>
          <img
            ...
            alt=""
            src="/componentcardglobalmedia-landscape-1@2x.png"
          />
          <div className={styles.componentcardglobaldark2}>여행 경로 설정</div>
          <div className={styles.componentcardglobaldark3}>
            나만의 여행 경로를 만들고 편집할 수 있습니다.
          </div>
        ...
        <div className={styles.componentcardplacecardGen2}>
          <img
            ...
            alt=""
            src="/componentcardglobalmedia-landscape-2@2x.png"
          />
          <div className={styles.componentcardglobaldark4}>여행자 커뮤니티</div>
          <div className={styles.componentcardglobaldark5}>
            <p className={styles.p}>여행지 후기들을 확인할 수 있습니다.</p>
            <p className={styles.p1}>여행 동행자들을 찾아볼 수 있습니다.</p>
          </div>
